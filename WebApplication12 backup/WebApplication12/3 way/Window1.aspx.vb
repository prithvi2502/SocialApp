...
Public Class Window1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If dr.HasRows Then
            ...
            HyperLink8.InnerText = dr.Item("fname")
            label_lastname.InnerText = dr.Item("lname")
            dr.Close()
    ...
    Private Sub update_Click(sender As Object, e As System.EventArgs) Handles update.Click
        If FileUpload1.HasFile Then
            ...
            cmd.Parameters.Add("@cchometown", SqlDbType.VarChar).Value = Image1.Src
    ...
    Protected Sub Repeater1_ItemCommand(source As Object, e As RepeaterCommandEventArgs)
        ...
        If e.CommandName = "Button1a" Then
            ...
            comment_var = DirectCast(item12.FindControl("commentbox1"), TextBox)
            For Each item As RepeaterItem In Repeater1.Items
                Dim txtName As TextBox = DirectCast(item.FindControl("commentbox1"), TextBox)
