...
Public Class WebForm29
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim cmd As SqlDataAdapter = New SqlDataAdapter("SELECT [fname], [lname] FROM [basicinfo] WHERE [email] = '" & Label16.Text & "'", cnn)
        Dim ds As DataSet = New DataSet()
        cmd.Fill(ds)
        Repeater4.DataSource = ds
        Repeater4.DataBind()
        Dim cmd1 As SqlDataAdapter = New SqlDataAdapter("SELECT [email], [works], [highschool], [college], [About], [hometown], [sex], [politicalviews], [mom], [Dad] FROM [tablefs1] WHERE [email] = '" & Label16.Text & "'", cnn)
        Dim ds1 As DataSet = New DataSet()
        cmd1.Fill(ds1)
        Repeater1.DataSource = ds1
        Repeater1.DataBind()
        Dim cmd2 As SqlDataAdapter = New SqlDataAdapter("SELECT [email], [gameinmusic2], [gameinmusic3], [gameinmusci4], [clan], [clanposition], [favgame], [gameinmusic], [whygames], [firstgame], [gamesys], [childhoodgames], [genreofgame] FROM [tablegc1] WHERE [email] = '" & Label16.Text & "'", cnn)
        Dim ds2 As DataSet = New DataSet()
        cmd2.Fill(ds2)
        Repeater2.DataSource = ds2
        Repeater2.DataBind()
        Dim cmd3 As SqlDataAdapter = New SqlDataAdapter("SELECT [music], [movies], [books], [games], [athelete], [sports], [sportsteam], [activities],  [inspire], [interests], [specialtoyou], [m2usic], [m2ovies], [b2ooks], [g2ames], [a2thelete], [s2ports], [s2portsteam], [a2ctivities],  [i2nspire], [i2nterests], [s2pecialtoyou], [m3usic], [m3ovies], [b3ooks], [g3ames], [a3thelete], [s3ports], [s3portsteam], [a3ctivities],  [i3nspire], [i3nterests], [s3pecialtoyou], [m4usic], [m4ovies], [b4ooks], [g4ames], [a4thelete], [s4ports], [s4portsteam], [a4ctivities],  [i4nspire], [i4nterests], [s4pecialtoyou]  FROM [tabless2] WHERE [email] = '" & Label16.Text & "'", cnn)
