<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/3 way/Site4.Master" CodeBehind="test.aspx.vb" Inherits="WebApplication12.WebForm38" %>
...
height: 1%;">
			             <div class="mainclass" style="width: 630px;">
		                            ...
		                            <a style="font-size: 14pt;" href='<%#"WebForm24.aspx?id=" + Eval("email")%>' class="links_link"><%#Eval("fname")%> <%#Eval("Lname")%></a>
		                                ...
		                                <div>
		                                   <div class="image_holder" style="margin-left: 10px; margin-top: 10px; width: 80px; height: 80px;">
		                                        <img ID="Image3" src='<%#Eval("hometown")%>' style="width: 100%;"  alt="This guy"  />
		                                   </div> 
		                                   <div id="discription" >
		                                       <br />
