<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/3 way/Site4.Master" CodeBehind="WebForm27.aspx.vb" Inherits="WebApplication12.WebForm27" %>
...
<div style="width: 511px; margin: 0 auto; height:inherit;">
        ...
        EventName="Tick" />
          ...
          <div id="image">
              <img src="login 2.jpg" alt="This guy" height="50" width="50" />
                ...
                <div class="user">
                <a id="manasdf"  herf="<%#"~/3 way/WebForm24.aspx?id=" + Eval("email")%>"> <%#Eval("fname")%> <%#Eval("Lname")%></a>
                  <ul id="coolasdfasdf">
                    <div>
                       <div id="imagebox1234">
                            <img src="login 2.jpg" alt="This guy" height="50" width="50" />
          ...
          <div id="comment">
               <%#Eval("c1")%><br />
               <%#Eval("datemonth")%>/<%#Eval("dateday")%>/<%#Eval("dateyear")%>
          </div>
