<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/3 way/Site4.Master" CodeBehind="WebForm37.aspx.vb" Inherits="WebApplication12.WebForm37" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div style="width: 980px;">   
     <div style ="width: 300px; margin-top: 30px;  height: auto; float: right; color: black; font-family: 'Segoe UI Semilight', 'Open Sans', Verdana, Arial, Helvetica, sans-serif;
font-weight: 300;
font-size: 11pt;
...
<div style="width: 611px; clear:both; height: inherit; overflow: hidden;   padding-top: 20px;  color: black;  height:inherit; font-family: 'Segoe UI Semilight', 'Open Sans', Verdana, Arial, Helvetica, sans-serif;
font-weight: 300;
font-size: 11pt;
letter-spacing: 0.02em;
line-height: 20px;">
   ...
   <ContentTemplate>
    ...
    <br />
      ...
      <div id="posts" style=" clear:both; height: inherit; overflow: hidden;" >
