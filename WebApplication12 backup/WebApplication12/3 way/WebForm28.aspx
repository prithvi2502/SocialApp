<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/3 way/Site4.Master" CodeBehind="WebForm28.aspx.vb" Inherits="WebApplication12.WebForm28" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<body>
		<div id="contentbox" style="height: 6000px;">
            ...
            <br />
                <asp:HyperLink ID="HyperLink1" NavigateUrl='<%#"~/3 way/Frienwind.aspx?id=" + Eval("email")%>' cssClass="Fontsys3" runat="server">Access Wall</asp:HyperLink>
            </ItemTemplate>
            </asp:Repeater>
			<br />
